...
<!--background-->
<h1>Agent's Registration Form </h1>
<div class="register-form-w3layouts">
    <!-- Form starts here -->
    <form action="<?= ($BASE) ?>/agents_signup" method="post">
        ...
        <div class="field-agileinfo-spc form-w3-agile-text1">
            ...
            <input type="checkbox" name="farms" id="farms" placeholder="" required="" value="OAU farms"> OAU farms
        </div>
