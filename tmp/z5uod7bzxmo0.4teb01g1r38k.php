                    ...
                    <div class="agile_top_brand_left_grid">
                        <div class="agile_top_brand_left_grid1">
                            <figure>
                                <div class="snipcart-item block" >
                                    <div class="snipcart-thumb">
                                        <a href="single.html"><img title=" " alt=" " src="assets/ecommerce/images/plantain.jpg" style="width: 140px; height: 140px;"/></a>
                                        <p>Plantain (1KG)</p>
                                    ...
                                    <div class="snipcart-details top_brand_home_details">
                                        <form action="#" method="post">
                                            <fieldset>
                                                ...
                                                <input type="hidden" name="add" value="1" />
                                                <input type="hidden" name="business" value=" " />
                                                <input type="hidden" name="item_name" value="Plantain (1KG)" />
                    ...
                    <div class="agile_top_brand_left_grid">
                        ...
                        <div class="agile_top_brand_left_grid1">
                            <figure>
                                <div class="snipcart-item block">
                                    <div class="snipcart-thumb">
                                        <a href="single.html"><img src="assets/ecommerce/images/banner6.jpg" alt=" " class="img-responsive" style="width: 140px; height: 140px;"/></a>
                                        <p>Chicken</p>
                                        <h4>&#8358;1499.99 <span>&#8358;1999.99</span></h4>
                                    </div>
                                    <div class="snipcart-details top_brand_home_details">
                                        <form action="#" method="post">
                                            <fieldset>
                                                ...
                                                <input type="hidden" name="amount" value="1499.99" />
                    ...
                    <div class="agile_top_brand_left_grid">
                        ...
                        <div class="agile_top_brand_left_grid1">
                            <figure>
                                <div class="snipcart-item block">
                                    <div class="snipcart-thumb">
                                        <a href="single.html"><img src="assets/ecommerce/images/banner4.jpg" alt=" " class="img-responsive" style="width: 140px; height: 140px;"/></a>
                                        <p>Turkey</p>
                                        <h4>&#8358;5999.99 <span>&#8358;6999.99</span></h4>
                                    </div>
                                    <div class="snipcart-details top_brand_home_details">
                                        <form action="#" method="post">
                                            <fieldset>
                                                ...
                                                <input type="hidden" name="add" value="1" />
                                                <input type="hidden" name="business" value=" " />
                                                <input type="hidden" name="item_name" value="Turkey" />
                                                <input type="hidden" name="amount" value="5999.99" />
