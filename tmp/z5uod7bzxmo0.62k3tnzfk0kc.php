		...
		<div class="privacy about">
	      ...
	      <div class="checkout-right">
			...
			<div class="checkout-left">
				...
				<form action="<?= ($BASE) ?>/payment" method="post" class="creditly-card-form agileinfo_form">
				        	...
				        	<a href="<?= ($BASE) ?>/my_payment">Make a Payment <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>
			      	</div>
					</div>
