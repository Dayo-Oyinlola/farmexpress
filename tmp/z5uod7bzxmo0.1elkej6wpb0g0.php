		...
		<div class="container">
				...
				<div class="agile_social_icons_banner">
					<ul class="agileits_social_list">
						...
						<li><a class="drop" href="#">Sign up</a>
							<ul>
								<li><a href="<?= ($BASE) ?>/users_reg">Customer</a></li>
								<li><a href="<?= ($BASE) ?>/agents_reg">Agent</a></li>
			...
			<div class="w3_banner_info">
				<div class="w3_banner_info_grid">
					<h3 class="test">Our goal is to bring farm produce to your doorstep in its fresh state and at an affordable price.</h3></br></br>
					...
					<ul>
						<li><a href="<?= ($BASE) ?>/view_farms" class="w3l_contact">View farms</a></li>
						<!--<li><a href="<?= ($BASE) ?>/home" class="w3ls_more">Buy Produce</a></li>-->
					</ul>
				</div>
			</div>
